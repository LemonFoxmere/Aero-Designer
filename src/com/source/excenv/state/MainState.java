...
public class MainState extends State {
	...
	private void renderSlider(Graphics2D g, StandardSlider s) {		
		...
		g.setFont(new Font("Montserrat", Font.PLAIN, 15));
	...
	public void render(Graphics g) {
		...
		//render section names
		{
			...
			g2D.setFont(new Font("Montserrat", Font.BOLD, 25));
		...
		g.drawImage(LemonOrangeLogo, (int) (GameMain.GAME_WIDTH-120), (int) (GameMain.GAME_HEIGHT-140), null);
		
		g2D.setColor(new Color(200, 200, 200));
		g2D.drawString("Copyright (c) 2021 Aerovate Inc.", (int) (GameMain.GAME_WIDTH/2-150), (int) (GameMain.GAME_HEIGHT-70));
		g2D.setFont(new Font("Montserrat", Font.PLAIN, 18));
		g2D.setColor(new Color(180, 180, 180));
		g2D.drawString("Created By LemonOrange. More details on https://github.com/LemonOrangeWasTaken/", (int) (GameMain.GAME_WIDTH/2-370), (int) (GameMain.GAME_HEIGHT-43));
	}
